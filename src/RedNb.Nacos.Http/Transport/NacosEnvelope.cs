...
internal static class NacosEnvelope
{
    ...
    public static void ThrowIfFailed(JsonElement root, string operation)
    {
        ...
        {
            var error = code is 401 or 403 ? NacosException.NoRight
                : code == NacosConstants.ConfigNotFoundCode ? NacosException.NotFound : NacosException.ServerError;
            throw new NacosException(error,
