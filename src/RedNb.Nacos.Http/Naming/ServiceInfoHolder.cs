...
public class ServiceInfoHolder
{
    ...
    private void SaveToDisk(ServiceInfo serviceInfo)
    {
        try
        {
            ...
            var json = System.Text.Json.JsonSerializer.Serialize(serviceInfo, NacosHttpJsonOptions.Create());
        ...
        try
        {
            ...
            foreach (var file in Directory.GetFiles(_cacheDir, "*.json"))
            {
                try
                {
                    ...
                    var serviceInfo = System.Text.Json.JsonSerializer.Deserialize<ServiceInfo>(json, NacosHttpJsonOptions.Create());
                    if (serviceInfo != null)
                    {
